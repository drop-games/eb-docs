...
$SPR rewards are easy to understand and imply streamlined redemption process. However, this might lead to $SPR price volatility and inflation. To mitigate this, we're pondering bringing a second token - __Timeore__.
...
Later Timeore would be burned to open NFT loot boxes, mint NFTs, or upgrade items (re-forge swords). This utility makes Timeore valuable for NFT collectors, who now have to buy Timeore from the players, thus creating a market for it.
